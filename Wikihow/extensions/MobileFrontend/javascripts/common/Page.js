( function( M, $ ) {
	 ...
	 */
	Page = View.extend( {
		template: mw.template.get( '../../wikihow/MobileFrontendWikihow/templates/pagewh' ),
		defaults: {
		...
		render: function( options ) {
			...
			if ( !options.sections ) {
				...
				M.pageApi.getPage( pageTitle ).done( function( pageData ) {
					...
					options.displayTitle = mw.msg( 'howto', options.displayTitle);
					self.displayTitle = options.displayTitle;
					self.articleText = options.articleText;
