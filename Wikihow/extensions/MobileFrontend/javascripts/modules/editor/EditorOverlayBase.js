( function( M, $ ) {
	...
	EditorOverlayBase = OverlayNew.extend( {
		...
		initialize: function( options ) {
			//XX CHANGED: BEBETH remove any dashes if they exist
			displayTitle = options.title.replace(/-/g, " ");
			if ( this.readOnly ) {
				options.readOnly = true;
				options.editingMsg = mw.msg( 'mobile-frontend-editor-viewing-source-page', displayTitle );
			} else {
				options.editingMsg = mw.msg( 'mobile-frontend-editor-editing-page', displayTitle );
			}
			options.previewingMsg = mw.msg( 'mobile-frontend-editor-previewing-page', displayTitle );
