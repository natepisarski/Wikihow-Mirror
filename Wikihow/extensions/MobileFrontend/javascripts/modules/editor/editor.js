( function( M, $ ) {
	...
	var
		...
		// WikiHow - Alberto, Sept. 2016: Include social login in the drawer
		WhCtaDrawer = M.require( 'WhCtaDrawer' ),
		drawer = new WhCtaDrawer( {
			queryParams: {
				campaign: 'mobile_editPageActionCta',
				returntoquery: 'article_action=edit&useformat=mobile',
				useformat: 'mobile'
			},
			signupQueryParams: { returntoquery: 'article_action=signup-edit&useformat=mobile' },
	...
	function init( page ) {
		// JRS 08/18/14 Load the current page if page is undefined
		page = page || M.getCurrentPage();
		if (true || typeof page !== "undefined") {
