...
GROOVY;
	...
	private function search( $type, $for ) {
		...
		// Custom filters.
		$extraFilters = array();
		$extraNotFilters = array();
		// Let hooks add some more filters.
		wfRunHooks('CirrusSearchExtraFilters', array(
		...
		// George 2015-04-15
		//$query->setExplain(true); // TODO: remove this
	...
	public function buildFullTextSearchFields( $weight, $fieldSuffix, $allFieldAllowed ) {
		...
		// George 2015-04-06
		// TODO: Add auxiliary weights
		// global $wgCirrusSearchAuxiliaryWeights;
		// if (isset($wgCirrusSearchAuxiliaryWeights)) {
		// 	foreach ($wgCirrusSearchAuxiliaryWeights as $fieldName=>$fieldWeight) {
		// 		$fields[] = "${fieldName}${fieldSuffix}^${fieldWeight}";
		// 	}
		// }
