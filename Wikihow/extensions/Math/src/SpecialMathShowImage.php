...
class SpecialMathShowImage extends SpecialPage {
	...
	public function setHeaders( $success = true ) {
		...
		if ( $success && !( $this->noRender ) ) {
			// Wikihow/Jordan: changed client side caching to 1 week on
			// the client side (from 1 hour), to help page speed
...
SVG;
	...
	// Wikihow/Reuben, Sept 3, 2015: We need this method so this the
