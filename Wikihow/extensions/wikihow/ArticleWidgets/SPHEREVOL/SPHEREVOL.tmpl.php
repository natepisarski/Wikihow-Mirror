...
<style type="text/css" media="all">/*<![CDATA[*/ @import "<?= wfGetPad('/extensions/min/f/extensions/wikihow/ArticleWidgets/common/css/style.css,/extensions/wikihow/ArticleWidgets/SPHEREVOL/css/styles.css,/extensions/wikihow/ArticleWidgets/components/whUpDownDropDown/wh.updowndropdown.css,/extensions/wikihow/ArticleWidgets/components/whLabel/wh.label.css&') . WH_SITEREV ?>"; /*]]>*/</style>
...
<body>
 ...
 $(function() {
    $("#result_si, #result_uk").empty().whLabel({value : "Please enter a decimal number (eg. 10)", lines: 2, fade: false, startFontSize: 16});        
 });
...
function tabs_switch(a) {
    ...
    $("#si").empty().whUpDownDropDown({units:"", width: 243, min: 0, value: 0, cut: 8, maxLength: 20, options : { "1" : "mm", "10" : "cm", "1000" : "m"}, dropDownDefault: 1, onChange: function(element, val, opt) { 
        ...
        $("#result_si").empty().whLabel({value : sphere_volume(val) + " " + i[opt], lines: 1, fade: false, startFontSize: 24});        
    ...
    $("#uk").empty().whUpDownDropDown({units:"", width: 243, min: 0, value: 0, cut: 8, maxLength: 20, options : { "1" : "ft", "10" : "in"}, dropDownDefault: 1, onChange: function(element, val, opt) { 
        var i = { "1" : "ft³" , "10" : "in³"};
        $("#result_uk").empty().whLabel({value : sphere_volume(val) + " " + i[opt], lines: 1, fade: false, startFontSize: 24});        
    }, onDropDownChange : function(element, val, opt) { 
        var i = { "1" : "ft³" , "10" : "in³"};
        $("#result_uk").empty().whLabel({value : sphere_volume(val) + " " + i[opt], lines: 1, fade: false, startFontSize: 24});        
    }});
