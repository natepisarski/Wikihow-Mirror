<div class='domitian_section'>
	...
	<p>
		Domitian Details aids in understanding the detailed usage of individual community tools over time.<br />
		Generates a ZIP of CSVs for the selected tools.<br />
		See also <a href='/Special:DomitianSummary'>Domitian Summary</a> and <a href='/Special:DomitianSegments'>Domitian Segments</a>.
	</p>
</div>
...
<div class='domitian_section'>
	<h3 class='domitian_header'>Aggregate by</h3>
	<form id='domitian_aggregate_by_form'>
		<input type='radio' name='domitian_aggregate_by' value='day' checked>Daily data</input><br />
		<input type='radio' name='domitian_aggregate_by' value='week'>Weekly data</input><br />
		<input type='radio' name='domitian_aggregate_by' value='month'>Monthly data</input>
	</form>
</div>
...
<div class='domitian_buttons'>
	<a class='button primary' id='domitian_generate'>Generate ZIP</a>
