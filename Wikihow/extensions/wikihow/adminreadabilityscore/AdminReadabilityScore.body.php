...
class AdminReadabilityScore extends UnlistedSpecialPage {
	...
	public function execute($par) {
		...
		$out->addModules( 'ext.wikihow.adminreadabilityscore' );
...
<div style="font-size: 13px; margin: 20px 0 7px 0;">
	Enter a list of URLs such as <code style="font-weight: bold;">https://www.wikihow.com/Be-a-Ninja</code> to process.<br />
	One per line.
</div>
