...
$.fn.extend({
  ...
  $.fn.sqlquerybuilder = function(options) {
  	$.fn.sqlquerybuilder.defaults = {
		...
		addnewcolumn:'[Click to add new column]',
		showcolumn:true,
		wheretitle:'With the following conditions:',
		addnewwhere:'[Click to add new condition]',
		showwhere:true,
		sorttitle:'Sort columns by..',
		addnewsort:'[Click to add new sort column]..',
		showsort:true,
		grouptitle:'Group columns by..',
		addnewgroup:'[Click to add new group column]..',
		showgroup:true,
		deletetext:'[remove]',
		animate:true,
		onchange:null,
