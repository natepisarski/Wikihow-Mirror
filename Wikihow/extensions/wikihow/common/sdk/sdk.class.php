...
CFLoader::autoloader("CFCredentials");
CFLoader::autoloader("AmazonDynamoDB");
CFLoader::autoloader("CFUtilities");
CFLoader::autoloader("CFCredential");
CFLoader::autoloader("AmazonSTS");
CFLoader::autoloader("CacheCore");
CFLoader::autoloader("CacheAPC");
CFLoader::autoloader("Signer");
CFLoader::autoloader("AuthV2Query");
CFLoader::autoloader("RequestCore");
CFLoader::autoloader("CFRequest");
CFLoader::autoloader("CFResponse");
CFLoader::autoloader("CFSimpleXML");
CFLoader::autoloader("AuthV4Query");
CFLoader::autoloader("AuthV3JSON");
CFLoader::autoloader("CFJSON");
CFLoader::autoloader("Array2DOM");
CFLoader::autoloader("CFArray");
