...
if ($wgLanguageCode == 'es') {
	$wgCategoryNames = array(
			...
			CAT_PETS => "Mascotas y animales",
			CAT_PHILOSOPHY => "Filosofía y religión",
			CAT_RELATIONSHIPS => "Relaciones",
			CAT_SPORTS => "Deportes",
			CAT_TRAVEL => "Viajes",
			// CAT_WIKIHOW => "wikiHow",
...
elseif($wgLanguageCode == 'fr') {
	$wgCategoryNames = array(
			...
			CAT_COMPUTERS => "Ordinateurs et l'électronique",
			...
			CAT_PETS => "Animaux et Animaux de Compagnie",
...
elseif($wgLanguageCode == 'it') {
	$wgCategoryNames = array(
			...
			CAT_FAMILY => "Famiglia",
			CAT_FINANCE => "Finanza Business e Materie Legali",
			CAT_FOOD => "Cucina",
			CAT_HEALTH => "Salute",
...
elseif($wgLanguageCode == 'ru') {
	$wgCategoryNames = array(
			...
			CAT_PHILOSOPHY => "Философия и религия",
...
elseif($wgLanguageCode == 'id') {
	$wgCategoryNames = array(
			...
			CAT_ARTS => "Seni dan Hiburan",
			CAT_CARS => "Mobil dan Otomotif",
			CAT_COMPUTERS => "Komputer dan Elektronik",
			CAT_EDUCATION => "Pendidikan dan Komunikasi",
			CAT_FAMILY => "Keluarga",
			CAT_FINANCE => "Keuangan dan Bisnis",
			CAT_FOOD => "Makanan dan Penjamuan",
			CAT_HEALTH => "Kesehatan",
			CAT_HOBBIES => "Hobi & Kerajinan Tangan",
			CAT_HOME => "Rumah dan Taman",
			CAT_HOLIDAYS => "Hari Raya dan Tradisi",
			CAT_PERSONAL => "Perawatan Diri dan Gaya",
			CAT_PETS => "Peliharaan & Hewan",
			CAT_PHILOSOPHY => "Filsafat dan Agama",
...
elseif($wgLanguageCode == 'th') {
	$wgCategoryNames = array(
			...
			CAT_COMPUTERS =>  "คอมพิวเตอร์และอุปกรณ์อิเล็กทรอนิกส์",
			...
			CAT_HOLIDAYS =>  "ฉลอง",
			CAT_HOME => "บ้านและสวน",
			CAT_PERSONAL =>  "การดูแลและไลฟ์สไตล์",
			CAT_PETS =>  "สัตว์และสัตว์เลี้ยง",
			CAT_PHILOSOPHY => "ปรัชญาและศาสนา",
			CAT_RELATIONSHIPS =>  "ความสัมพันธ์ทางสังคม",
...
elseif($wgLanguageCode == 'vi') {
	$wgCategoryNames = array(
			...
			CAT_PERSONAL => "Chăm sóc Cá nhân và Phong cách",
