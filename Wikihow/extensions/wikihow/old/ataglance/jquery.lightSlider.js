        ...
        plugin = {
            ...
            pager: function () {
                ...
                refresh.createPager = function () {
                    thumbWidth = ((elSize - settings.pagerPadding) - ((settings.thumbItem * (settings.thumbMargin)) - settings.thumbMargin)) / settings.thumbItem;
            ...
            slideThumb: function () {
                ...
                if ((thumbSlide + elSize) > pagerWidth) {
                    thumbSlide = pagerWidth - elSize + settings.pagerPadding - settings.thumbMargin;
                }
                if (thumbSlide < 0) {
                    thumbSlide = 0;
                }
