...
class QAtest {
	...
	*/
	...
	function getQAhtml($data) {
		...
		// $rand = mt_rand(0,2);
		// $template = ($rand == 1) ? 'QAtest' : 'QAtest_accordian';
		// $template = __DIR__.'/qatest/'.$template;
		// $template = __DIR__.'/QAtest_sidebox';
		$template = __DIR__.'/QAtest.tmpl.php';
		...
		$qa_html = EasyTemplate::html($template, $vars);
		return $qa_html;
	}
