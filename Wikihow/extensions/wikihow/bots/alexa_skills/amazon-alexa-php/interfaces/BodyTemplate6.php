...
/**
 * BodyTemplate6 abstraction
 *
 * https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/display-interface-reference#bodytemplate6
 */
class BodyTemplate6 implements DisplayTemplateInterface {
	...
	public function render() {
		...
		$template = [
			...
			'template' => [
				'type' => DisplayTemplateTypes::TYPE_BODY_TEMPLATE_6,
				"token" => DisplayTemplateTypes::TYPE_BODY_TEMPLATE_6,
				"backButton" => "VISIBLE",
				'title' => $this->getTitle(),
