...
/**
 * BodyTemplate2 abstraction
 *
 * https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/display-interface-reference#bodytemplate2
 */
class BodyTemplate2 implements DisplayTemplateInterface {
	...
	public function render() {
		...
		$template = [
			...
			'template' => [
				'type' => DisplayTemplateTypes::TYPE_BODY_TEMPLATE_2,
				"token" => DisplayTemplateTypes::TYPE_BODY_TEMPLATE_2,
				"backButton" => "HIDDEN",
				'title' => $this->getTitle(),
