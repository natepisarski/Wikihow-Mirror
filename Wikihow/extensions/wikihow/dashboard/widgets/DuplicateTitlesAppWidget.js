...
WH.dashboard.DuplToolAppWidget = (function($) {
	...
	function DuplicateTitlesAppWidget() {

		this.getWidgetName = function(){
			return "DuplicateTitlesAppWidget";
		}

		// Called by WH.dashboard.init after it's done running
		this.init = function() {
			unpatrolledNode = $('.comdash-widget-DuplicateTitlesAppWidget .comdash-count span');
			lastImage = $('.comdash-widget-DuplicateTitlesAppWidget .comdash-lastcontributor .avatar');
			lastName = $('.comdash-widget-DuplicateTitlesAppWidget .comdash-lastcontributor .name');
			lastTime = $('.comdash-widget-DuplicateTitlesAppWidget .comdash-lastcontributor .time');
			completedNode = $('.comdash-widget-DuplicateTitlesAppWidget .comdash-today');
			topImage = $('.comdash-widget-DuplicateTitlesAppWidget .comdash-topcontributor .avatar');
			topName = $('.comdash-widget-DuplicateTitlesAppWidget .comdash-topcontributor .name');
			topTime = $('.comdash-widget-DuplicateTitlesAppWidget .comdash-topcontributor .time');

			/*$('.comdash-widget-DuplicateTitlesAppWidget .comdash-start').click(function(){
				gatTrack('comm_engagement', 'categorize_start', 'dashboard');
			});
			$('.comdash-widget-DuplicateTitlesAppWidget .comdash-login').click(function(){
	...
	DuplicateTitlesAppWidget.prototype = new WH.dashboard.DashboardWidget();

	// Instantiate this widget
	widget = new DuplicateTitlesAppWidget();

	// Listen for data updates from the server
	WH.dashboard.registerDataListener('DuplicateTitlesAppWidget', widget);
