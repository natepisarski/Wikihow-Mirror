...
WH.dashboard.WriteAppWidget = (function($) {
	...
	function WriteAppWidget() {
		...
		this.init = function() {
			...
			topImage = $('.comdash-widget-WriteAppWidget .comdash-topcontributor .avatar');
			topName = $('.comdash-widget-WriteAppWidget .comdash-topcontributor .name');
			topTime = $('.comdash-widget-WriteAppWidget .comdash-topcontributor .time');
