...
WH.dashboard.WelcomeWagonWidget = (function($) {
	...
	function WelcomeWagonWidget() {

		this.getWidgetName = function(){
			return "WelcomeWagonWidget";
		}

		// Called by WH.dashboard.init after it's done running
		this.init = function() {
			unpatrolledNode = $('.comdash-widget-WelcomeWagonWidget .comdash-count span');
			lastImage = $('.comdash-widget-WelcomeWagonWidget .comdash-lastcontributor .avatar');
			lastName = $('.comdash-widget-WelcomeWagonWidget .comdash-lastcontributor .name');
			lastTime = $('.comdash-widget-WelcomeWagonWidget .comdash-lastcontributor .time');
			completedNode = $('.comdash-widget-WelcomeWagonWidget .comdash-today');
			topImage = $('.comdash-widget-WelcomeWagonWidget .comdash-topcontributor .avatar');
			topName = $('.comdash-widget-WelcomeWagonWidget .comdash-topcontributor .name');
			topTime = $('.comdash-widget-WelcomeWagonWidget .comdash-topcontributor .time');
		};
	...
	WelcomeWagonWidget.prototype = new WH.dashboard.DashboardWidget();

	// Instantiate this widget
	widget = new WelcomeWagonWidget();

	// Listen for data updates from the server
	WH.dashboard.registerDataListener('WelcomeWagonWidget', widget);
