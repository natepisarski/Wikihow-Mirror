...
WH.dashboard.TechFeedbackAppWidget = (function($) {
	...
	function TechFeedbackAppWidget() {

		this.getWidgetName = function(){
			return "TechFeedbackAppWidget";
		}

		// Called by WH.dashboard.init after it's done running
		this.init = function() {
			unpatrolledNode = $('.comdash-widget-TechFeedbackAppWidget .comdash-count span');
			lastImage = $('.comdash-widget-TechFeedbackAppWidget .comdash-lastcontributor .avatar');
			lastName = $('.comdash-widget-TechFeedbackAppWidget .comdash-lastcontributor .name');
			lastTime = $('.comdash-widget-TechFeedbackAppWidget .comdash-lastcontributor .time');
			completedNode = $('.comdash-widget-TechFeedbackAppWidget .comdash-today');
			topImage = $('.comdash-widget-TechFeedbackAppWidget .comdash-topcontributor .avatar');
			topName = $('.comdash-widget-TechFeedbackAppWidget .comdash-topcontributor .name');
			topTime = $('.comdash-widget-TechFeedbackAppWidget .comdash-topcontributor .time');

			/*$('.comdash-widget-TechFeedbackAppWidget .comdash-start').click(function(){
				gatTrack('comm_engagement', 'categorize_start', 'dashboard');
			});
			$('.comdash-widget-TechFeedbackAppWidget .comdash-login').click(function(){
	...
	TechFeedbackAppWidget.prototype = new WH.dashboard.DashboardWidget();

	// Instantiate this widget
	widget = new TechFeedbackAppWidget();

	// Listen for data updates from the server
	WH.dashboard.registerDataListener('TechFeedbackAppWidget', widget);
