...
WH.dashboard.QAPatrolWidget = (function($) {
	...
	function QAPatrolWidget() {

		// Called by WH.dashboard.init after it's done running
		this.init = function() {
			unpatrolledNode = $('.comdash-widget-QAPatrolWidget .comdash-count span');
			lastImage = $('.comdash-widget-QAPatrolWidget .comdash-lastcontributor .avatar');
			lastName = $('.comdash-widget-QAPatrolWidget .comdash-lastcontributor .name');
			lastTime = $('.comdash-widget-QAPatrolWidget .comdash-lastcontributor .time');
			completedNode = $('.comdash-widget-QAPatrolWidget .comdash-today');
			topImage = $('.comdash-widget-QAPatrolWidget .comdash-topcontributor .avatar');
			topName = $('.comdash-widget-QAPatrolWidget .comdash-topcontributor .name');
			topTime = $('.comdash-widget-QAPatrolWidget .comdash-topcontributor .time');

			/*$('.comdash-widget-QAPatrolWidget .comdash-start').click(function(){
				gatTrack('comm_engagement', 'qc_start', 'dashboard');
			});
			$('.comdash-widget-QAPatrolWidget .comdash-login').click(function(){
				gatTrack('comm_engagement', 'qc_login', 'dashboard');
			});*/
		};

		this.getWidgetName = function(){
			return "QAPatrolWidget";
		}
	...
	QAPatrolWidget.prototype = new WH.dashboard.DashboardWidget();

	// Instantiate this widget
	widget = new QAPatrolWidget();
