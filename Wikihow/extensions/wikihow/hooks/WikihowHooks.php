...
$wgHooks['BeforeInitialize'][] = array('PageHooks::redirectIfLoginWithReturnToRequest');
...
$wgHooks['NewRevisionFromEditComplete'][] = array('ArticleHooks::onNewRevisionFromEditCompleteAddFirstContributionTag');
