...
$namespaceNames[NS_FILE] = 'Immagine';
$namespaceNames[NS_FILE_TALK] = 'Discussioni_immagine';

unset($namespaceAliases['Immagine']);
unset($namespaceAliases['Discussioni_immagine']);
$namespaceAliases['File'] = NS_FILE;
$namespaceAliases['Discussioni_file'] = NS_FILE_TALK;
