...
//Changes by Gershon Bialer to preserve image namespaces
$namespaceNames[NS_FILE] = 'Bild';
$namespaceNames[NS_FILE_TALK] = 'Bild_Diskussion';

unset($namespaceAliases['Bild']);
