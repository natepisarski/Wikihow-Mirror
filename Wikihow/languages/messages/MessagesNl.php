...
//Changes added by Gershon Bialer to fix image namespace
$namespaceNames[NS_FILE] = 'Afbeelding';
$namespaceNames[NS_FILE_TALK] = 'Overleg_afbeelding';

unset($namespaceAliases['Afbeelding']);
unset($namespaceAliases['Overleg_afbeelding']);
$namespaceAliases['Bestand'] = NS_FILE;
$namespaceAliases['Overleg_bestand'] = NS_FILE_TALK;
