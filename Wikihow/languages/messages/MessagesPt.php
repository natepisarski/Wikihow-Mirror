...
$namespaceNames[NS_FILE] = 'Imagem';
$namespaceNames[NS_FILE_TALK] = 'Imagem_Discussão';

unset($namespaceAliases['Imagem']);
unset($namespaceAliases['Imagem_Discussão']);
$namespaceAliases['Ficheiro'] = NS_FILE;
$namespaceAliases['Ficheiro_Discussão'] = NS_FILE_TALK;
