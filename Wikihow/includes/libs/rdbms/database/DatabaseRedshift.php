...
/**
 * HACK HACK HACK HACK HACK - by Drew
 ...
 * @ingroup Database
 */
class DatabaseRedshift extends Database {
	/** @var int|bool */
	protected $port;
	...
	protected function open( $server, $user, $password, $dbName, $schema, $tablePrefix ) {
		...
		$connectVars = [
			...
			'dbname' => strlen( $dbName ) ? $dbName : 'redshift',
			'user' => $user,
			'password' => $password
		];
 ...
 */
class_alias( DatabaseRedshift::class, 'DatabaseRedshift' );
