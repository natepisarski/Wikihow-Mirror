...
abstract class ReverseChronologicalPager extends IndexPager {
	...
	function getNavigationBar() {
		...
		//XXCHANGEDXX Bebeth, added navigation div for styling
		$this->mNavigationBar = '<div class="navigation">' . $firstLastLinks . ' ' .
			$this->msg( 'viewprevnext' )->rawParams(
				$pagingLinks['prev'], $pagingLinks['next'], $limits )->escaped() . '</div>';
