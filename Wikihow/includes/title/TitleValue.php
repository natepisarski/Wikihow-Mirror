...
class TitleValue implements LinkTarget {
	...
	public function getText() {
		// Wikihow: Don't translate underscores to dashes in the names of special
		// pages. We had problems with the INTL (ES, DE) /Special:CreateAccount and
		// /Special:UserLogout URLs if we do this translation of underscores to dashes.
		if ( $this->inNamespace(NS_SPECIAL) ) {
			return $this->dbkey;
		} else {
