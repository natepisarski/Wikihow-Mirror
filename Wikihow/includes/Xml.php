...
class Xml {
	...
	public static function dateMenu( $year, $month ) {
		...
		$inputAttribs = [ 'id' => 'year', 'maxlength' => 4, 'size' => 7, 'class' => 'input_med' ];
		return self::label( wfMessage( 'input-year' )->text(), 'year', [ 'class' => 'input_med noborder' ] ) . ' ' .
			Html::input( 'year', $encYear, 'number', $inputAttribs ) . '&#160;' .
			self::label( wfMessage( 'input-month' )->text(), 'month', [ 'class' => 'input_med noborder' ] ) . ' ' .
