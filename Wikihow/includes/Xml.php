...
class Xml {
	...
	public static function dateMenu( $year, $month ) {
		...
		return self::label( wfMessage( 'input-year' )->text(), 'year', array('class' => 'input_med noborder') ) . ' ' .
			Html::input( 'year', $encYear, 'number', $inputAttribs ) . '&#160;' .
			self::label( wfMessage( 'input-month' )->text(), 'month', array('class' => 'input_med noborder') ) . ' ' .
