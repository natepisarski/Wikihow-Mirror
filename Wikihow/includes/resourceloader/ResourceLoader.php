...
MESSAGE;
	...
	public static function makeLoaderQuery( $modules, $lang, $skin, $user = null,
		...
		// Wikihow: added our own versioning
	...
	public function getLessCompiler( $vars = [] ) {
		...
		// Wikihow: we import less variables and paths here because it
		// used to be done here, and it's easiest to do it this way with
		// our (older) version of MobileFrontend.
		$moreVars = self::getLESSVars();
		$parser->ModifyVars( $vars + $moreVars );

		$extraDirs = ($wgResourceLoaderLESSImportPaths ?? []);
