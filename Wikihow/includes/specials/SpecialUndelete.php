		...
		if ( $this->mAllowed && ( $haveRevisions || $haveFiles ) ) {
			...
			$table =
				...
				<tr>
					...
					"</td>
					<td class='mw-input'>" .
					// Bebeth, upgrade 1.21: added class
					Xml::input( 'wpComment', 50, $this->mComment, array( 'id' => 'wpComment', 'autofocus' => true, 'class' => 'input_med' ) ) .
					"</td>
				</tr>
				<tr>
					<td>&#160;</td>
					<td class='mw-submit'>" .
					// Bebeth, upgrade 1.21: added class
					Xml::submitButton( $this->msg( 'undeletebtn' )->text(), array( 'name' => 'restore', 'id' => 'mw-undelete-submit', 'class' => 'button primary' ) ) . ' ' .
					Xml::submitButton( $this->msg( 'undeleteinvert' )->text(), array( 'name' => 'invert', 'id' => 'mw-undelete-invert', 'class' => 'button secondary' ) ) .
					"</td>
				</tr>" .
					$unsuppressBox .
