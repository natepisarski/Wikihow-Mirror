...
class SpecialWatchlist extends ChangesListSpecialPage {
	...
	public function doHeader( $opts ) {
		...
		// don't add it to the subtitle. just show it [sc - 01/10/2014]
		$this->getOutput()->addHTML('<p>'.SpecialEditWatchlist::buildTools( null ).'</p><br />');
		...
		$form .= Xml::submitButton( $this->msg( 'allpagessubmit' )->text(), array('class' => 'button primary small') ) . "</p>\n";
	...
	function setTopText( FormOptions $opts ) {
		...
		if ( $numItems > 0 && $wgShowUpdatedMarker ) {
			...
			Xml::submitButton( $this->msg( 'enotif_reset' )->text(), array( 'name' => 'dummy', 'class' => 'button primary' ) ) . "\n" .
