...
class SpecialMergeHistory extends SpecialPage {
	...
	public function execute( $par ) {
		...
		$this->getOutput()->addHTML( 'This page has been disabled by wikiHow because the features it monitors ' .
			'do not work properly with our system presently. If you feel that we should address this, please ' .
