...
class SpecialChangeContentModel extends FormSpecialPage {
	...
	// Wikihow, July 2019: Added this, after discussing with Anna some of these 
	// features, and decided that having community contact us if they really want
	// this stuff would be the best way to approach.
	public function execute($par) {
        $this->getOutput()->addHTML( 'This page has been disabled by wikiHow because the features it accesses ' .
            'are not properly supported within our system presently. Everything has and should have the "wikitext" content ' .
			'type on wikiHow right now. If you would like to discuss this more, please contact us.' );
        return;
	}
