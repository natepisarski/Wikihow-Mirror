...
class SpecialSearch extends SpecialPage {
	...
	public function execute( $par ) {
		// Wikihow/George, May 2015: Disable Special:Search for anons.
		// Ref Lighthouse ticket #1195
		if ($this->getUser()->isAnon()) {
			// Displays a stock "Login required" message
		...
		$term = htmlspecialchars( $term, ENT_NOQUOTES, 'UTF-8');

		// George 2015-04-10: Let hooks add some styles and scripts
		Hooks::run( 'SpecialSearchAddModules', [ $this, $out ] );
