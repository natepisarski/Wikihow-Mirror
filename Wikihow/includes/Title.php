...
class Title {
	...
	private function secureAndSplit() {
		...
		// JRS Don't remove underscores from title names. Messes things up for wikiHow
		$dbkey = preg_replace( '/[ \xA0\x{1680}\x{180E}\x{2000}-\x{200A}\x{2028}\x{2029}\x{202F}\x{205F}\x{3000}]+/u', '-', $dbkey );
		$dbkey = trim( $dbkey, '-' );
