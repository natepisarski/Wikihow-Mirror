...
class LogPager extends ReverseChronologicalPager {
	...
	/**
	 * Reuben, upgrade 1.23: overload this method to be able to insert a FORCE INDEX (times)
	 * in the least hacky way, other than fixing the broken Database class that causes an SQL 
	 * syntax error.
	 */
	...
	public function setIndexHack() {
		$this->doIndexHack = true;
	}
