...
class Article implements Page {
	...
	public function showPatrolFooter() {
		...
		// WIKIHOW - added hook to optionally not show the patrol footer
		if ( ! wfRunHooks( 'ArticleShowPatrolFooter', array() ) ) {
			return false;
		}
		...
		$form = Xml::openElement( 'form', array( 'method' => 'post',
			...
			<tr id=\"wpDeleteReasonRow\">
				...
				Html::input( 'wpReason', $reason, 'text', array(
					...
					'id' => 'wpReason',
					'autofocus',
					// WIKIHOW - added css class to this input
					'class' => 'input_med'
				) ) .
				"</td>
			</tr>";
		...
		$form .= "
			...
			<tr>
				...
				<td class='mw-submit'>" .
					...
					// WIKIHOW - added css class to this button
						array( 'name' => 'wpConfirmB', 'id' => 'wpConfirmB', 'tabindex' => '5', 'class' => 'button primary' ) ) .
				"</td>
			</tr>" .
	...
	/**
	 * wikiHow patch for deprecated function
	 */
	 ...
	 * wikiHow patch for deprecated function
	 */
	function insertNewArticle($text, $summary, $minor, $watchthis, $forceBot = false, $sectionanchor = '' ) {
		wfDeprecated( __METHOD__ );
