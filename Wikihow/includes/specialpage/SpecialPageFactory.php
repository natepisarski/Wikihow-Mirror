...
class SpecialPageFactory {
	...
	private static $coreList = [
		...
		// Data and tools
		//'ApiSandbox' => \SpecialApiSandbox::class, // Wikihow removed
	...
	public function resolveAlias( $alias ) {
		...
		$caseFoldedAlias = str_replace( ' ', '-', $caseFoldedAlias ); // Wikihow: was underscore
	...
	public function getLocalNameFor( $name, $subpage = false ) {
		...
		if ( $subpage !== false && !is_null( $subpage ) ) {
			...
			$subpage = str_replace( ' ', '-', $subpage ); // Wikihow: was underscore
			$name = "$name/$subpage";
		}
